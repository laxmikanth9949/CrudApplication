sap.ui.define([
	...
	return Opa5.extend("com.template.CURDsample.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/template/CURDsample/localService/mockserver"], function (mockserver) {
